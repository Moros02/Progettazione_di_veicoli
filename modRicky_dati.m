...
data.X_TO=1500;        %Lunghezza di pista in takeoff [m]  %1800
data.X_LA=1428;        %Lunghtzza di pista in landing [m]  %1500
...
data.a_frenata=1.7;    % Accelerazione in frenata Tra 1.2 e 1.8 [m/s^2]  %1.6
